                                    ...
                                    <li class="list-group-item list-group-item-success">
                                        ...
                                        <label class="strikethrough"><?= $dt['nama_task'] ?>
                                            ...
                                            <?php if ($dt['mark_done'] == NULL) : ?>
                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#markdone<?= $dt['id']; ?>"><i data-feather=" trash-2">Mark Done</i></button>

                                            <?php else : ?>
                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#undone<?= $dt['id']; ?>"><i data-feather=" trash-2">Mark Undone</i></button>
                        ...
                        <div class="card-body">
                            <ul class="list-group ">
                                ...
                                <?php foreach ($dotoday as $today) : ?>
                                    ...
                                    <div class="modal fade" id="todayundone<?= $today['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelDefault" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                    ...
                                    <div class="modal fade" id="todaydone<?= $today['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelDefault" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
